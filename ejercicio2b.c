...
int enqueue(Cola *c, Pedido p) {

    if (c->size >= MAX_ORDENES) {
        return 0; //  no se pudo
    }
        ...
        do {
            ...
            case 1:
                ...
                if (enqueue(&cola, p)) {
                      ...
                      printf("No se pueden recibir más comandas (limite alcanzado)\n");
                }
